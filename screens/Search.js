         ...
         <ListItem key={i} bottomDivider subtitleNumberOfLines={0}>
          ...
          <ListItem.Subtitle>
            ...
            <Menu renderer={ContextMenu} onSelect={value => this.selectNumber(value)}>
              ...
              <MenuOptions>
                <MenuOption onSelect={()=>this.props.navigation.navigate('View', { screen: 'ViewLocation', params: {latitude:item.latitude, longitude:item.longitude, name:item.Name,notes:item.notes}})} text="View" />
                {console.log("LATITUDE IS " + item)}
                <MenuOption onSelect={() => this.props.navigation.navigate('Update', { screen: 'UpdateLocation', params: {latitude:item.latitude, longitude:item.longitude, name:item.Name,notes:item.notes}})} text="Update" />
